      ...
      <main className="flex w-full h-full dark:bg-dbg">
        <div className="flex flex-col flex-grow max-w-2xl mx-auto md:px-0 dark:bg-dbg">
          <div className="flex-grow pt-32 items-center mx-auto w-full max-w-xl sm:pl-2 sm:pr-2">
            ...
            <h1 className='text-center text-xl font-bold mb-6'>Privacy Policy</h1>
            <p>
              Abdulmelik Kalkan built the Ads Blocker for Youtube app as a Free
              app. This SERVICE is provided by Abdulmelik Kalkan at no cost and
            ...
            <p>
              ...
              our Terms and Conditions, which are accessible at Ads Blocker for
              Youtube unless otherwise defined in this Privacy Policy.
            </p>
            <p>
              <br></br>
            ...
            <p>This policy is effective as of 2022-08-29</p>
            <p>
              <br></br>
            ...
            <p>
              ...
              do not hesitate to contact me at kalkanabdulmelik@gmail.com.
            </p>
            <p>
